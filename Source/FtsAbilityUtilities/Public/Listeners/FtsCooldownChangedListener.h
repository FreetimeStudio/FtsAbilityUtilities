...
#include "FtsCooldownChangedListener.generated.h"
...
class FTSABILITYUTILITIES_API UFtsCooldownChangedListener : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UFtsCooldownChangedListener* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
